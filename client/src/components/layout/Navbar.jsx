    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
        ...
        <Link to="/" className="flex items-center gap-2">
          <span className="text-xl font-bold tracking-tight">LUXESCENT</span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
          ...
          <Link to="/?category=men" className="transition-colors hover:text-primary/80">
            Men
          </Link>
          <Link to="/?category=women" className="transition-colors hover:text-primary/80">
            Women
          </Link>
          <Link to="/?category=unisex" className="transition-colors hover:text-primary/80">
            Unisex
          </Link>
        </nav>
                    ...
                    <div className="absolute right-0 top-full z-50 mt-2 w-56 rounded-md border border-border bg-card shadow-lg">
                      ...
                      <div className="p-1">
                        ...
                        <button
                          ...
                          className="flex w-full items-center gap-2 rounded-sm px-3 py-2 text-sm hover:bg-accent text-destructive cursor-pointer"
                        >
